        ...
        <Container className="relative z-50 flex justify-between py-8">
          ...
          <div className="flex items-center gap-6">
                      ...
                      <>
                        ...
                        >
                          <div className="space-y-4">
                            ...
                            <MobileNavLink href="https://talentclaw.ai">
                              ClawOS
                            </MobileNavLink>
                          </div>
                          <div className="mt-8 flex flex-col gap-4">
                            ...
                            <Button className="cursor-default pointer-events-none opacity-80">
            ...
            <div className="flex items-center gap-6 max-lg:hidden">
              <Button href="https://talentclaw.ai" variant="outline">
                Visit ClawOS
              </Button>
              <Button className="cursor-default pointer-events-none opacity-80">App Store Coming Soon</Button>
            </div>
          </div>
        </Container>
      </nav>
